			...
			<section class="content"> <!--产品信息-->
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="password" class="form-control" id="editPwd1" autocomplete="off" name="editPwd1"
								   placeholder="修改密码" value="">
						</div>
						<div class="col-md-2 title">确认密码</div>
						<div class="col-md-4 data">
							<input type="password" class="form-control" id="editPwd2" autocomplete="off" name="editPwd2"
...
<script>
	function save(){
		$.ajax({
			type:"POST",
			url:"${pageContext.request.contextPath}/user/doEditPwd",
			data: {
