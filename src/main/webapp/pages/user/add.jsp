			...
			<form>
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="password" class="form-control" autocomplete="off" id="editPwd1" name="editPwd1"
								   placeholder="密码" value="">
						</div>
						<div class="col-md-2 title">确认密码</div>
						<div class="col-md-4 data">
							<input type="password" class="form-control" autocomplete="off" id="editPwd2" name="editPwd2"
								   placeholder="密码" value="">
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" autocomplete="off" id="phoneNum" name="phoneNum"
								placeholder="联系电话" value="">
						</div>
						<div class="col-md-2 title">用户角色</div>
						<div class="col-md-10 data">
							<c:forEach items="${roleList}" var="role">
								<input class="" type="checkbox" id="selectBox" name="selectBox" value="${role.id}">${role.roleName}
							</c:forEach>
						</div>
