...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				用户管理 <small>登录用户:${loginUsername}</small>
			</h1>
			<ol class="breadcrumb">
...
<%--											</td>--%>
<%--											<td class="text-center">--%>
<%--												<a href="${pageContext.request.contextPath}/role/edit/${}" class="btn bg-olive btn-xs">编辑</a>--%>
<%--											</td>--%>
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/edit/${user.id}" class="btn bg-olive btn-xs">编辑</a>
